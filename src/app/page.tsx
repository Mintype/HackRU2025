  ...
  return (
    <div className="min-h-screen rel  ative bg-gradient-to-br from-blue-100 via-white to-purple-100">
      ...
      <nav className="container mx-auto px-6 py-6 backdrop-blur-sm bg-white/80 sticky top-0 z-50 rounded-b-2xl shadow-sm">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex space-x-8">
            <a href="#features" className="text-gray-900 dark:text-gray-600 hover:text-purple-600 dark:hover:text-purple-400 transition">Features</a>
            <a href="#how-it-works" className="text-gray-900 dark:text-gray-600 hover:text-purple-600 dark:hover:text-purple-400 transition">How It Works</a>
            <a href="#about" className="text-gray-900 dark:text-gray-600 hover:text-purple-600 dark:hover:text-purple-400 transition">About</a>
          </div>
      ...
      <section className="container mx-auto px-6 py-20 text-center">
        <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-800 bg-clip-text text-transparent animate-gradient-flow-slow">
          Language Learning Machine
        </h1>
        <p className="text-xl md:text-2xl text-gray-700 mb-12 max-w-3xl mx-auto mt-16 leading-relaxed">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a href="/login" className="bg-gradient-to-r from-blue-600 to-purple-800 text-white px-8 py-4 rounded-full text-lg font-semibold hover:shadow-2xl hover:shadow-purple-500/50 transition-all duration-300 transform hover:scale-105 inline-block animate-gradient-flow">
            Start Learning
          </a>
        </div>
      </section>
      ...
      <section id="features" className="container mx-auto px-6 py-20">
        <h2 className="text-4xl md:text-5xl font-bold text-center mb-16 bg-gradient-to-r from-blue-600 to-purple-800 bg-clip-text text-transparent animate-gradient-flow-slow">
          Main Features
        </h2>
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {/* Feature 1 */}
          <div className="bg-white/80 backdrop-blur-sm p-8 rounded-3xl shadow-xl hover:shadow-2xl border border-gray-100 transition-all duration-300 transform hover:scale-105 hover:-translate-y-2">
          ...
          {/* Feature 2 */}
          <div className="bg-white/80 backdrop-blur-sm p-8 rounded-3xl shadow-xl hover:shadow-2xl border border-gray-100 transition-all duration-300 transform hover:scale-105 hover:-translate-y-2">
            <div className="w-16 h-16 bg-gradient-to-br from-cyan-500 to-blue-700 rounded-2xl flex items-center justify-center mb-6 shadow-lg">
              <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {/* Feature 3 */}
          <div className="bg-white/80 backdrop-blur-sm p-8 rounded-3xl shadow-xl hover:shadow-2xl border border-gray-100 transition-all duration-300 transform hover:scale-105 hover:-translate-y-2">
            <div className="w-16 h-16 bg-gradient-to-br from-pink-500 to-pink-700 rounded-2xl flex items-center justify-center mb-6 shadow-lg">
              <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {/* Feature 5 */}
          <div className="bg-white/80 backdrop-blur-sm p-8 rounded-3xl shadow-xl hover:shadow-2xl border border-gray-100 transition-all duration-300 transform hover:scale-105 hover:-translate-y-2">
            <div className="w-16 h-16 bg-gradient-to-br from-yellow-500 to-orange-700 rounded-2xl flex items-center justify-center mb-6 shadow-lg">
              <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {/* Feature 6 */}
          <div className="bg-white/80 backdrop-blur-sm p-8 rounded-3xl shadow-xl hover:shadow-2xl border border-gray-100 transition-all duration-300 transform hover:scale-105 hover:-translate-y-2">
            <div className="w-16 h-16 bg-gradient-to-br from-indigo-500 to-indigo-700 rounded-2xl flex items-center justify-center mb-6 shadow-lg">
              <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section id="how-it-works" className="container mx-auto px-6 py-20 bg-gradient-to-br from-white to-purple-50/50 rounded-3xl my-20 shadow-xl border border-gray-100">
        <h2 className="text-4xl md:text-5xl font-bold text-center mb-16 bg-gradient-to-r from-blue-600 to-purple-800 bg-clip-text text-transparent animate-gradient-flow-slow">
          How It Works
        </h2>
        <div className="grid md:grid-cols-3 gap-12">
          <div className="text-center">
            <div className="w-20 h-20 bg-gradient-to-br from-blue-500 to-purple-700 rounded-full flex items-center justify-center mx-auto mb-6 text-white text-3xl font-bold shadow-lg hover:scale-110 transition-transform duration-300 animate-gradient-flow">
              1
            </div>
          ...
          <div className="text-center">
            <div className="w-20 h-20 bg-gradient-to-br from-purple-500 to-indigo-700 rounded-full flex items-center justify-center mx-auto mb-6 text-white text-3xl font-bold shadow-lg hover:scale-110 transition-transform duration-300 animate-gradient-flow">
              2
            </div>
      ...
      {/* CTA Section */}
      <section className="container mx-auto px-6 py-20 text-center">
        <div className="bg-gradient-to-r from-blue-600 via-purple-700 to-indigo-800 rounded-3xl p-12 md:p-20 shadow-2xl border border-purple-500/20 animate-gradient-flow-slow">
          ...
          <a href="/login" className="bg-white text-purple-600 px-10 py-4 rounded-full text-lg font-semibold hover:shadow-2xl hover:shadow-white/50 transition-all duration-300 transform hover:scale-105 inline-block">
            Start Now
          </a>
        </div>
      </section>
      ...
      <section id="about" className="container mx-auto px-6 py-20">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white/80 backdrop-blur-sm p-8 md:p-12 rounded-3xl shadow-xl border border-gray-100">
